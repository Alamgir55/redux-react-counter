    ...
    render () {
        return (
            <div>
                ...
                <CounterControl label="Decrement" clicked={this.props.onDecementCounter}  />
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onStoreResult: (result) => dispatch(actionCreator.store_result(result)),
        onDeleteResult: (id) => dispatch(actionCreator.delete_result(id))
    };
};
